...
> 이번 환경 세팅은 AIC를 같이하는 분들의 도움을 받고 성황리(?)에 끝낼 수 있었다. 장지수님 임진수님 감사합니다. 블로그 홍보드립니다.  
    - 장지수님 블로그 : https://simonjisu.github.io/  
    - 임진수님 블로그 : https://jinsu-l.github.io/home
...
- 새로설치할 우분투환경에서 jupyter notebook이나 VScode로 코딩 및 분석 또는 CMD에서 명령어 실행
- 게임할때가 문서 작업은 윈도우에서 작업
...
다음 글 : [듀얼 부팅 [Windows10/Ubuntu] ML/DL 환경세팅 : Part 2: SSH/Jupyter notebook 서버 설치!](https://datanetworkanalysis.github.io/2020/01/06/dual_part2)